 ...
 */
public class VolleydeleteMemberListProfile {
    private String Tag_json_obj = "_req_delete_request";
    Context _vcontext;
    ...
    public VolleydeleteMemberListProfile(Context mcontext) {
        this._vcontext = mcontext;
    }

    public void GetDeleteMemberprofileRequest(JSONObject param, final String accesstoken, VolleyCallback callback) {

        JsonObjectRequest myReq = new JsonObjectRequest(Request.Method.POST,
                Constant.URL_deletememberprofile, param,
