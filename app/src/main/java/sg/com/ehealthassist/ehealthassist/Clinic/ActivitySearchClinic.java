...
/**
 * Created by Wunna Tun on 04-Jan-18.
 */

public class ActivitySearchClinic extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    ImageButton btnRefreshQueue, buttonmyclinic, imagebtn_openclose, image_map, toolbar_imgbutton_back;
    CardView btnDrDuty,btnRegisterQueue,btnApptSlot;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_clinic_detail);
        initialize();
        findViewsById();
...
//        lblContactLabel2 = (TextView) findViewById(R.id.textViewClinicDetailsContact2);
        ...
        btnRegisterQueue = (CardView) findViewById(R.id.buttonRegisterQueue);
        btnDrDuty = (CardView) findViewById(R.id.buttonDrDuty);
        buttonmyclinic = (ImageButton) findViewById(R.id.buttonmyclinic);
        btnApptSlot = (CardView) findViewById(R.id.buttonApptSlot);
...
//        lblContactLabel2.setVisibility(View.GONE);
    ...
    private void getGoogleMapsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ActivitySearchClinic.this);
