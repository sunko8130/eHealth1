...
public class VolleyMedicalDispenseCount {
    private String Tag_json_obj = "_req_medDispense_Count_request";
    Context _vcontext;
    ...
    public VolleyMedicalDispenseCount(Context mcontext){
        this._vcontext = mcontext;
    }
    public void GetMedDispensCount(final String accesstoken, VolleyCallback callback){
        JsonObjectRequest _reqjson = new JsonObjectRequest(Request.Method.GET, Constant.URL_MedDispensecount,
