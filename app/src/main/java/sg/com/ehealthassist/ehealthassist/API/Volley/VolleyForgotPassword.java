...
public class VolleyForgotPassword {
    private String Tag_json_obj = "_req_forgotpwd_request";
    Context _vcontext;
    ...
    public VolleyForgotPassword(Context mcontext) {
        this._vcontext = mcontext;
    }

    public void GetForgotPwdRequest(JSONObject param, VolleyCallback callback) {

        JsonObjectRequest myReq = new JsonObjectRequest(Request.Method.POST,
                Constant.URL_ForgotPassword, param,
