...
public class VolleyInvoiceRate {
    private String Tag_json_obj = "_req_invoice_rating";
    Context _vcontext;
    ...
    public VolleyInvoiceRate(Context mcontext) {
        this._vcontext = mcontext;
    }

    public void GetInvoiceRating(JSONObject param, final String accesstoken, VolleyCallback callback) {

        JsonObjectRequest myReq = new JsonObjectRequest(Request.Method.POST,
                Constant.URL_InvoiceRate, param,
    ...
    public void setvolleyResultText(JSONObject resultjson, VolleyCallback callback) {
        try {
            ...
            if (status.equals("Ok")) {
                ...
                if (dataarray.has("IsSuccess")) {
                    id = dataarray.getString("IsSuccess");
                }
