 ...
 */
public class VolleyUpdateMemberListProfile {
    private String Tag_json_obj = "_req_update_memberprofile";
    Context _vcontext;
    ...
    public VolleyUpdateMemberListProfile(Context mcontext) {
        this._vcontext = mcontext;
    }

    public void GetUpdateMemberprofileRequest(JSONObject param, final String accesstoken, VolleyCallback callback) {

        JsonObjectRequest myReq = new JsonObjectRequest(Request.Method.POST,
                Constant.URL_updatememberprofile, param,
