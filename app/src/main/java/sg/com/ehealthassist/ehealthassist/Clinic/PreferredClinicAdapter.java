 ...
 */
public class PreferredClinicAdapter extends BaseAdapter {

    public Activity activity;
    private List<ClinicInfo> clinicInfos;
    String from_activity;

    public PreferredClinicAdapter(Activity a, List<ClinicInfo> clinicInfoList, String f_act) {
        activity = a;
        from_activity = f_act;
    ...
    private class ViewHolder {
        TextView clinicId,clinicName,blockno,street,unitno,buildingname,postalcode;
