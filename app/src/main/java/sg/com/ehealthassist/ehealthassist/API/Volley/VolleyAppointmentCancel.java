 ...
 */
public class VolleyAppointmentCancel {
    private String Tag_json_obj = "_req_appt_cancel";
    Context _vcontext;
    private ProgressDialog pDialog;

    public VolleyAppointmentCancel(Context _mcontext) {
        _vcontext = _mcontext;
    ...
    public void GetApptCancelJson(final String accesstoken, JSONObject param, VolleyCallback callback) {
        showpDialog();
        String uri = String
                .format(Constant.URL_CANCEL);
