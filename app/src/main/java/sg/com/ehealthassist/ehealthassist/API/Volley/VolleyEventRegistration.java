...
public class VolleyEventRegistration {
    private String Tag_json_obj = "_req_event_registraion";
    Context _vcontext;
    ...
    public VolleyEventRegistration(Context mcontext) {
        this._vcontext = mcontext;
    }

    public void GetEventRegistraionRequest(JSONObject param, final String accesstoken, VolleyCallback callback) {

        Log.e("data",param.toString());
        Log.e("accesstoken",accesstoken);
        JsonObjectRequest myReq = new JsonObjectRequest(Request.Method.POST,
                Constant.URL_EventRegistraion, param,
    ...
    public void setvolleyResultText(JSONObject resultjson, VolleyCallback callback) {
        try {
            ...
            if (status.equals("OK")) {
                ...
                if (dataarray.has("id")) {
                     memberid = dataarray.getString("id");
                }
