    ...
    public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialTabsPrimaryColor, getResources().getColor(R.color.colorPrimaryDark));
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor, getResources().getColor(R.color.cas_color_tab_yellow));
