 ...
 */
public class VolleyQueueCancel {
    private String Tag_json_obj = "_req_queue_cancel";
    Context _vcontext;
    private ProgressDialog pDialog;

    public VolleyQueueCancel(Context _mcontext) {
        _vcontext = _mcontext;
    ...
    public void GetQueueCancelJson(final String accesstoken, final int clinicid, JSONObject param, VolleyCallback callback) {
        showpDialog();
        Log.e("rqcanceljson", param.toString());
        String uri = String
                .format(Constant.URL_QUEUECANCEL + clinicid);
    ...
    public void setTvResultText(JSONObject response, VolleyCallback callback) {
        ...
        try {
            ...
            Log.e("rescancel", response.toString());
